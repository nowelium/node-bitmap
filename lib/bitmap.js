...
Bitmap.prototype.getData = function (asRgbObj){
  ...
  var // ensure padded to DWORD (32bits)
...
Bitmap.prototype.read = (buf, offset, limit) => {
  var read = [];
...
Bitmap.prototype.readColorPalette_RGBTRIPLE = (bitCount, startPos) => {
  throw new Error('not yet impl');
};
...
Bitmap.prototype.mapRGBA = (r, g, b, a, asRgbObj) => {
  var hex = [];

  var padHex = (value, asRgbObj) => {
